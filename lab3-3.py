...
python = monty_python[6:20]		# Используйте оператор среза для получения подстроки “Python”
print("rez =",python)
...
print("ice" in ice_cream , " - ice in my word ")
print("Ice" and "ice" in ice_cream, " - ice and Ice in my word ")
